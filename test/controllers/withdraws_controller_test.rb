...
class WithdrawsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create withdraw" do
    assert_difference('Withdraw.count') do
      post withdraws_url, params: { withdraw: { amount: @withdraw.amount, from_hajji_id: @withdraw.from_hajji_id, operation_date: @withdraw.operation_date, to_user_id: @withdraw.to_user_id } }, as: :json
    end
  ...
  test "should update withdraw" do
    patch withdraw_url(@withdraw), params: { withdraw: { amount: @withdraw.amount, from_hajji_id: @withdraw.from_hajji_id, operation_date: @withdraw.operation_date, to_user_id: @withdraw.to_user_id } }, as: :json
    assert_response 200
  end
